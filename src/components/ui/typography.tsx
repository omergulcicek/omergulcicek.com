	...
	return (
		<Comp
			...
			className={cn(
				...
				"prose-headings:font-sans prose-headings:font-semibold prose-headings:text-balance prose-headings:text-foreground",
				...
				"prose-lead:text-base prose-lead:text-foreground",
...
function Heading<T extends HeadingTypes = "h1">({
	...
	return (
		<Comp
			className={cn(
				"flex flex-row items-center gap-2 scroll-m-20 text-foreground",
