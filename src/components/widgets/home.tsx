			...
			<section className="flex flex-col gap-2 md:gap-6">
				<div className="flex items-start">
					...
					>
						<div
							className={cn(
								"group rounded-full border border-black/5 bg-yellow-100 text-xs md:text-base text-white transition-all ease-in select-none hover:cursor-default dark:border-white/5 dark:bg-yellow-900"
							)}
						>
