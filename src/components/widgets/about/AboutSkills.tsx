		...
		<Section title="Hakkımda">
			<div className="flex flex-col gap-4 text-base leading-7 text-neutral-500">
				...
				<p>
					...
					<span className="text-black">Core Web Vitals</span> metrik takibi ve{" "}
				...
				<p>
					...
					<span className="text-black">code review</span> süreçlerini
					standartlaştırıyor,{" "}
				...
				<p>
					...
					<span className="text-black">Frontend Architect</span> rolüne
