		...
		>
			...
			<g fill="none" fillRule="evenodd">
				...
				<g transform="translate(0 11.083)">
					<mask id="raindrop-icon-b" fill="#fff">
						<use href="#raindrop-icon-a" />
					</mask>
					<use fill="#2CD4ED" href="#raindrop-icon-a" />
					<path
						fill="#0DB4E2"
						...
						mask="url(#raindrop-icon-b)"
					/>
				</g>
				<g transform="translate(19 11.083)">
					<mask id="raindrop-icon-d" fill="#fff">
						<use href="#raindrop-icon-c" />
					</mask>
					<use fill="#3169FF" href="#raindrop-icon-c" />
					<path
						fill="#3153FF"
