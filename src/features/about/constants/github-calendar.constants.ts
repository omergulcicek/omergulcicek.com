...
export const GITHUB_CALENDAR_WIDTH_PX =
	GITHUB_CALENDAR_WEEKS * (GITHUB_CALENDAR_BLOCK_SIZE + GITHUB_CALENDAR_BLOCK_MARGIN) -
...
export const GITHUB_CALENDAR_CONTENT_HEIGHT_PX =
...
export const GITHUB_CALENDAR_CONTAINER_HEIGHT_PX =
	GITHUB_CALENDAR_CONTENT_HEIGHT_PX + GITHUB_CALENDAR_WRAPPER_PADDING_Y
