	...
	if (variant === "dock") {
		return (
			<Button
				...
				className="h-7 min-w-7 gap-1.5 rounded-full bg-muted px-2.5 text-xs font-medium text-muted-foreground hover:bg-muted/80 hover:text-foreground dark:hover:bg-muted/80"
			>
