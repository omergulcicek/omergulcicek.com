...
`object-view-box` özelliği henüz çok yeni; Chrome Canary'de mevcut fakat [Google Chrome'a 104. versiyondan itibaren geleceği](https://groups.google.com/a/chromium.org/g/blink-dev/c/-s-nu3A-qAo/m/YYlxSLKkAgAJ?pli=1) söyleniyor.
