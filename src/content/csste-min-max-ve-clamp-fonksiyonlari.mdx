...
- [developer.mozilla.org](https://developer.mozilla.org/en-US/docs/Web/CSS/clamp())
- [css-tricks.com](https://css-tricks.com/min-max-and-clamp-are-css-magic/)
- [Paige Niedringhaus Youtube Kanalı](https://www.youtube.com/channel/UCy_hqs-R621ZWUrNHf7vJAA)
