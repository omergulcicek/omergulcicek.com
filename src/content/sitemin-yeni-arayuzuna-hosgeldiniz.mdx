...
Bu yaklaşımda [Chánh Đại'nin portföyünden](https://chanhdai.com/) ilham aldım. Minimal ama etkili bir tasarım anlayışını benimsedim.

## Kişiselleştirme ve Avatar

<img src="/blog/2025-07-27/avatar.png" alt="nice-avatar omergulcicek" width="200"/>

Severek takip ettiğim [Adem İlter](https://ademilter.com/)'in geliştirdiği [vue-nice-avatar](https://github.com/ademilter/vue-nice-avatar) projesini kullanarak avatarımı oluşturdum. Bu harika araç sayesinde oluşturduğum avatar'ı:
