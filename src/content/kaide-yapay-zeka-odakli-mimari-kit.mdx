...
contentHash: "c8c6c92c3d3bb5cc"
---

<BlogNotice title="Proje yeniden adlandırıldı" variant="warning">
	Bu makalede tanıtılan <strong>Kaide</strong> projesi artık{" "}
	<a
		href="https://www.virastack.com/tr/ai-rules/"
		target="_blank"
		rel="noopener noreferrer"
	>ViraStack AI</a>{" "}
	adıyla yayınlanıyor. Güncel kurulum ve dokümantasyon için{" "}
	<a href="/blog/virastack-ai">ViraStack AI makalesine</a> ve{" "}
	<a
		href="https://github.com/virastack/ai-rules"
		target="_blank"
		rel="noopener noreferrer"
	>GitHub deposuna</a>{" "}
	bakabilirsiniz. Metindeki eski <em>Kaide</em> adları tarihsel bağlam içindir.
</BlogNotice>
...
**Kaide** (artık ViraStack AI), modern React uygulamaları için geliştirilmiş, yapay zekâ (AI) odaklı bir mimari kitidir. Özellikle Cursor gibi yapay zekâ destekli editörler ve LLM'ler ile çalışırken, modelin proje bağlamını kaybetmesini önlemek, halüsinasyonları azaltmak ve yüksek disiplinli bir kod yapısı oluşturmak amacıyla tasarlanmıştır.

## İsmin Hikayesi

Projelerimde genellikle tek kelimelik, Türkçe ve projenin amacını doğrudan çağrıştıran isimler seçmeye dikkat ediyorum. Tıpkı [Nizam (ViraStack Next.js Boilerplate)](/blog/nizam-nextjs-16-boilerplate/) projemde olduğu gibi, bu mimari kit için de anlamlı bir isim arayışındaydım.
...
⭐ GitHub üzerinden **yıldız** vererek destek olabilirsiniz: [github.com/virastack/ai-rules](https://github.com/virastack/ai-rules)
