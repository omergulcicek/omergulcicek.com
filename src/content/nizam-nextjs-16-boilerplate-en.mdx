...
contentHash: "cfb5f17618cda84c"
---

<BlogNotice title="Project renamed" variant="warning">
	The <strong>Nizam</strong> project in this article is now published as{" "}
	<a
		href="https://www.virastack.com/en/nextjs-boilerplate/"
		target="_blank"
		rel="noopener noreferrer"
	>ViraStack Next.js Boilerplate</a>{" "}
	under the{" "}
	<a
		href="https://www.virastack.com/en/"
		target="_blank"
		rel="noopener noreferrer"
	>ViraStack</a>{" "}
	organization. Find the current source, setup steps, and live demo at those
	links. Older <em>Nizam</em> names in the post are kept for historical context.
</BlogNotice>

Introducing my new Next.js 16 boilerplate for building modern web applications quickly, securely, and enjoyably: Nizam (now ViraStack Next.js Boilerplate).
...
- **Live Demo**: [virastack.com/en/nextjs-boilerplate](https://www.virastack.com/en/nextjs-boilerplate/)
- **GitHub**: [virastack/nextjs-boilerplate](https://github.com/virastack/nextjs-boilerplate)
