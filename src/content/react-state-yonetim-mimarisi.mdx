...
* **Sık değişen veya paylaşılan UI state'leri** ise: [Zustand](https://zustand.docs.pmnd.rs/) (İleri düzey kullanım için [Zustand ve React Context](/blog/zustand-ve-react-context) yazısına göz atabilirsiniz).
...
**[ViraStack Next.js Boilerplate](https://www.virastack.com/tr/nextjs-boilerplate/)** (eski adı Nizam): Next.js projeleri için standartları belirlenmiş, ölçeklenebilir ve nizamlı bir başlangıç kiti.
...
- [Choosing the Right State Strategy in React](https://jsdev.space/react-state-management/) - JavaScript Development Space  
