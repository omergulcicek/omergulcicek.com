...
contentHash: "e6d8f19c50c73476"
---

<BlogNotice title="Proje yeniden adlandırıldı" variant="warning">
	Bu makalede tanıtılan <strong>Nizam</strong> projesi artık{" "}
	<a
	...
	adıyla{" "}
	<a
		href="https://www.virastack.com/tr/"
		target="_blank"
		rel="noopener noreferrer"
	>ViraStack</a>{" "}
	organizasyonunda yayınlanıyor. Güncel kaynak kodu, kurulum ve canlı demoyu bu
	bağlantılardan inceleyebilirsiniz. Metindeki eski <em>Nizam</em> adları tarihsel
	bağlam içindir.
</BlogNotice>

Modern web uygulamalarını hızlı, güvenli ve zevkli şekilde inşa etmek için hazırladığım yeni Next.js 16 boilerplate’imi tanıtıyorum: Nizam (artık ViraStack Next.js Boilerplate).
