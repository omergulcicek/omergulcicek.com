...
contentHash: "26ee8095f9d1e857"
---

<BlogNotice title="Project renamed" variant="warning">
	The <strong>Kaide</strong> project in this article is now published as{" "}
	<a
		href="https://www.virastack.com/en/ai-rules/"
		target="_blank"
		rel="noopener noreferrer"
	>ViraStack AI</a>
	. See the{" "}
	<a href="/blog/virastack-ai">ViraStack AI article</a> and the{" "}
	<a
		href="https://github.com/virastack/ai-rules"
		target="_blank"
		rel="noopener noreferrer"
	>GitHub repository</a>{" "}
	for current setup and docs. Older <em>Kaide</em> names in the post are kept for
	historical context.
</BlogNotice>
...
**Kaide** (now ViraStack AI) is an AI-native architecture kit engineered for modern React applications. It is specifically designed to prevent context loss, mitigate hallucinations, and enforce a highly disciplined code structure when working with AI-powered editors like Cursor and LLMs.

## The Story Behind the Name

I generally opt for single-word, Turkish names for my projects that directly evoke their purpose. Just as with my [Nizam (ViraStack Next.js Boilerplate)](/blog/nizam-nextjs-16-boilerplate/) project, I was looking for a meaningful name for this architecture kit.
...
⭐ You can support the project by starring it on GitHub: [github.com/virastack/ai-rules](https://github.com/virastack/ai-rules)
