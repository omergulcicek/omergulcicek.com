...
Bu kodun nasıl çalıştığını incelemek için [Codesandbox](https://codesandbox.io/p/devbox/github/tanstack/virtual/tree/main/examples/react/fixed?embed=1&theme=dark) örneğine göz atabilirsiniz.

Ayrıca, yatay kaydırma, hem yatay hem dikey kaydırma gibi özelliklerin yanı sıra, memoization gibi ek özellikler de mevcut. Detaylı bilgi için [resmi dokümantasyonu](https://tanstack.com/virtual/latest/docs/framework/react/examples/fixed) inceleyebilirsiniz.
...
- [TanStack Virtual Dokümantasyon](https://tanstack.com/virtual/latest/docs/introduction)
- [npm trends: @tanstack/react-virtual vs react-virtualized vs react-window](https://npmtrends.com/@tanstack/react-virtual-vs-react-virtualized-vs-react-window)
