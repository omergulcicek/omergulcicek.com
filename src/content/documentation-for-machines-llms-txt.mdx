...
In my Nizam boilerplate (now ViraStack Next.js Boilerplate), I treat `llms.txt` as part of the core architecture. The guide lives under `/public`, so any LLM agent can ingest the project’s structure and conventions in seconds.
...
[View the llms.txt file in the ViraStack Next.js Boilerplate project.](https://github.com/virastack/nextjs-boilerplate/blob/main/public/llms.txt)
