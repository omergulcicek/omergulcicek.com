...
contentHash: "f0ea994553414c0b"
---

<BlogNotice title="Eski sürüm" variant="warning">
	Bu makale Next.js 15 dönemindeki boilerplate'i anlatır. Proje önce{" "}
	<strong>Nizam</strong>, ardından{" "}
	<a
		href="https://www.virastack.com/tr/nextjs-boilerplate/"
		target="_blank"
		rel="noopener noreferrer"
	>ViraStack Next.js Boilerplate</a>{" "}
	adıyla ViraStack organizasyonuna taşındı. Güncel sürüm için{" "}
	<a href="/blog/nizam-nextjs-16-boilerplate/">Nizam (Next.js 16)</a> makalesine
	veya doğrudan{" "}
	<a
		href="https://www.virastack.com/tr/nextjs-boilerplate/"
		target="_blank"
		rel="noopener noreferrer"
	>ViraStack sitesine</a>{" "}
	bakın.
</BlogNotice>
...
**GitHub:** [github.com/virastack/nextjs-boilerplate](https://github.com/virastack/nextjs-boilerplate)  
**Canlı Demo:** [virastack.com/tr/nextjs-boilerplate](https://www.virastack.com/tr/nextjs-boilerplate/)
...
- GitHub Issues: [github.com/virastack/nextjs-boilerplate/issues](https://github.com/virastack/nextjs-boilerplate/issues)
