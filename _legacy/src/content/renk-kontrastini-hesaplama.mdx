...
category: "teknik"
tags: ["JavaScript"]
medium: "https://omergulcicek.medium.com/renk-kontrastını-hesaplama-8c8c8c8c8c8c"
---
...
<iframe
	...
	style={{ width: "100%" }}
	scrolling="no"
	title="Renk Konstratı"
	src="https://codepen.io/omergulcicek/embed/MWpEdaQ?height=265&theme-id=light&default-tab=js,result"
	frameBorder="no"
	loading="lazy"
...
- <a
  	href="https://24ways.org/2010/calculating-color-contrast/"
  	target="_blank"
  	rel="noreferrer noopener"
  >
  	Brian Suda - Calculating Color Contrast
  </a>
- <a
  	href="https://www.youtube.com/watch?v=tJNltOn-2Yg"
  	target="_blank"
  	rel="noreferrer noopener"
  >
  	Tayfun Erbilen - React ile Brand Colors Uygulaması
  </a>
