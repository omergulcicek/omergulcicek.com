...
import { CalendarSubscriptionUpdateNotice } from "@/features/blog/components/calendar-subscription-update-notice"
...
export const components = {
	...
	p: ({ children, ...props }: React.ComponentProps<"p">) => (
		<p
			className="text-foreground text-base leading-relaxed md:text-lg mb-8 md:mb-12"
			{...props}
		>
			{children}
		</p>
